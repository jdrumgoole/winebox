...
**Notable context:** No application code changes since the last review (2026-08-03). HEAD is at `ce02af6` (version 0.7.86). The only change since last review is yesterday's security report being merged. Dependency versions unchanged in lockfile. One new INFO finding (INFO-51) added for two newly published cryptography CVEs. certifi CA bundle row updated. All other 50 INFO findings carried forward.
...
- Only change since last review: yesterday's security report merged (commit `ce02af6`). HEAD at `ce02af6`.
...
| :yellow_circle: INFO | 51 |
| :green_circle: CLEAN | 12 categories |

**Date of review:** 2026-08-04
**Reviewer:** Automated security audit (Claude Code)
**Codebase version:** 0.7.86 (commit ce02af6)

### Comparison with Previous Review (2026-08-03)

| Item | 2026-08-03 | 2026-08-04 | Status |
|------|-----------|-----------|--------|
| CRITICAL | 0 | 0 | Maintained |
| WARNING | 0 | 0 | Maintained |
| INFO | 50 | 51 | +1 new (INFO-51) |

### Changes Since Last Review

- No application code changes since last review (HEAD at `ce02af6`, previous security review commit only).
- All dependency versions unchanged in lockfile.
- **New finding:** INFO-51 — Two newly published CVEs for cryptography 46.0.7 (CVE-2026-69248 wildcard DNS escape, CVE-2026-69249 exponential path-building DoS). Both fixed in 49.0.0. No practical impact on WineBox.
- **Updated findings:** INFO-7 and INFO-33 cross-referenced to INFO-51.
- **Updated table:** certifi row updated to note 2026.7.22 availability.
- All other 50 INFO findings carried forward unchanged.
