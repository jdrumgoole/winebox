...
**Notable context:** No application code changes since the last review (2026-06-17). HEAD is at `53b9155` (version 0.7.86). Dependency versions unchanged. All 25 INFO-level findings from the previous review carried forward. Two new CVEs discovered and assessed — CVE-2026-53539 (python-multipart) and CVE-2026-32690 (pydantic-settings) — neither exploitable in WineBox's current configuration (INFO-26 and INFO-27).
...
- **Status:** Carried forward from 2026-06-08 review (originally covered only CVE-2026-48526; expanded 2026-06-17 to include four additional June 2026 CVEs).
...
| Item | 2026-06-17 | 2026-06-21 | Status |
|------|-----------|-----------|--------|
| CRITICAL | 0 | 0 | Maintained |
| WARNING | 0 | 0 | Maintained |
| INFO | 25 | 27 | +2 new CVEs (INFO-26, INFO-27) |

### Changes Since Last Review

- No application code changes since last review (HEAD at `53b9155`).
- All dependency versions unchanged.
- **INFO-26 (new):** CVE-2026-53539 discovered in python-multipart 0.0.28 — quadratic-complexity DoS in `QuerystringParser` with semicolons. Limited impact on WineBox: all form-accepting endpoints require authentication, nginx caps body size at 10 MB. Fix: bump to >=0.0.30.
- **INFO-27 (new):** CVE-2026-32690 discovered in pydantic-settings 2.12.0 — path traversal in `NestedSecretsSettingsSource`. Not exploitable in WineBox: the vulnerable `NestedSecretsSettingsSource` class is not used anywhere in the codebase. Fix: bump to >=2.14.2.
...
3. **Bump python-multipart to >=0.0.30 (INFO-26)** — closes CVE-2026-53539 (QuerystringParser DoS). While the attack surface is limited by auth requirements and nginx body size limits, this is a simple dependency bump with no breaking changes.
