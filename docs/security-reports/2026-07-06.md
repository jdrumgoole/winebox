...
**Notable context:** No application code changes since the last review (2026-07-04). HEAD is at `8b2264c` (version 0.7.86). Dependency versions unchanged in lockfile. All 32 INFO-level findings from the previous review carried forward. Five new INFO-level findings added for newly disclosed CVEs in transitive dependencies (16 new CVEs across 5 packages discovered since the 2026-07-04 review).
...
**INFO-33: cryptography 46.0.7 is affected by GHSA-537c-gmf6-5ccf (OpenSSL vulnerability in bundled copy)** :new:
...
- **Status:** New in 2026-07-06 review.

**INFO-34: python-multipart 0.0.28 is affected by two additional CVEs (CVE-2026-53540, CVE-2026-53538)** :new:
...
**INFO-35: Starlette 0.50.0 is affected by three additional CVEs (CVE-2026-54282, CVE-2026-54283, CVE-2026-48817)** :new:
...
**INFO-36: aiohttp 3.13.5 is affected by nine additional CVEs — no practical impact on WineBox** :new:
...
**INFO-37: urllib3 2.6.3 is affected by CVE-2026-44432 (decompression bomb) — no practical impact on WineBox** :new:
...
| starlette | — | 0.50.0 | CVE-2026-48710 + 3 new CVEs — no practical impact (see INFO-8, INFO-35) |
...
| cryptography | >=46.0.7 | 46.0.7 | New OpenSSL advisory (see INFO-33) |
...
- No code changes since last review. HEAD at `8b2264c` (previous security review commit only).
...
| :yellow_circle: INFO | 37 |
| :green_circle: CLEAN | 12 categories |

**Date of review:** 2026-07-06
**Reviewer:** Automated security audit (Claude Code)
**Codebase version:** 0.7.86 (commit 8b2264c)

### Comparison with Previous Review (2026-07-04)

| Item | 2026-07-04 | 2026-07-06 | Status |
|------|-----------|-----------|--------|
...
- No application code changes since last review (HEAD at `8b2264c`, previous security review commit only).
- All dependency versions unchanged in lockfile.
- All 32 INFO findings carried forward unchanged.
- **5 new INFO findings** (INFO-33 through INFO-37) added for 16 newly disclosed CVEs across 5 transitive dependencies:
  - INFO-33: cryptography — 1 new OpenSSL advisory (GHSA-537c-gmf6-5ccf)
  - INFO-34: python-multipart — 2 new CVEs (CVE-2026-53540, CVE-2026-53538)
  - INFO-35: Starlette — 3 new CVEs (CVE-2026-54282, CVE-2026-54283, CVE-2026-48817)
  - INFO-36: aiohttp — 9 new CVEs (total now 11 across INFO-19, 21, 36)
  - INFO-37: urllib3 — 1 new CVE (CVE-2026-44432)
- None of the new CVEs are exploitable via WineBox's current architecture and usage patterns.
- Full re-audit of all 12 categories confirms no regressions.

### Top 3 Priorities

1. **Batch dependency upgrade (INFO-33, INFO-34, INFO-26)** — cryptography (GHSA-537c-gmf6-5ccf), python-multipart (3 CVEs), and PyJWT (5 CVEs) are the highest-value upgrades. All three are straightforward version bumps with no expected breaking changes. This single maintenance session would close 9 CVEs.
2. **Plan coordinated FastAPI + Starlette upgrade (INFO-8, INFO-35)** — Starlette 0.50.0 now has 4 CVEs (up from 1). While none are exploitable in WineBox, the accumulating count adds urgency. Requires upgrading FastAPI from 0.128.1 to >=0.135.0.
