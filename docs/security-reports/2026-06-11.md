...
**Notable context:** No application code changes since the last review (2026-06-10). HEAD is at commit `6589ea4` (the 2026-06-10 security review merge). Dependency versions unchanged. One minor change noted: certifi CA bundle is now one release behind (2026.4.22 vs 2026.5.20 released since last review). All 21 INFO-level findings carried forward unchanged.
...
- **Status:** Carried forward from 2026-05-17 review. Latest version updated from 48.0.0 to 48.0.1.
...
No dependencies are yanked, compromised, or missing critical patches. No lockfile changes since last review. No supply chain concerns — none of the 2026 compromised packages (LiteLLM, PyTorch Lightning, durabletask) are WineBox dependencies.
...
- Only commit since last review: `6589ea4` (merge of 2026-06-10 security review — documentation only).
...
**Codebase version:** 0.7.85 (commit 6589ea4)

### Comparison with Previous Review (2026-06-10)

| Item | 2026-06-10 | 2026-06-11 | Status |
|------|-----------|-----------|--------|
...
| INFO-7 (cryptography version gap) | Carried forward | Carried forward | Latest now 48.0.1 |
...
- Fresh CVE database search across all 22 key dependencies found no new advisories since 2026-06-10.
- certifi CA bundle is now one release behind (2026.4.22 locked vs 2026.5.20 available) — no security impact, noted in dependency table.
