...
**Notable context:** No application code changes since the last review (2026-06-05). HEAD is at commit `dc654b3` (the 2026-06-05 security review merge). Dependency versions unchanged. Two new CVEs discovered in the PyJWT and aiohttp ecosystems (CVE-2026-48526, CVE-2026-47265); neither is exploitable in WineBox's configuration. All 17 INFO-level findings carried forward; 2 new INFO findings added (INFO-18, INFO-19).
...
- **Status:** New finding in 2026-06-08 review.
...
| aiohttp | >=3.13.4 | 3.13.5 | Patched for CVE-2026-34520 + CVE-2026-34519 + CVE-2026-34516; CVE-2026-47265 not exploitable (see INFO-19) |
...
- Only commits since last review: `dc654b3` (merge of 2026-06-05 security review — documentation only).
...
| Item | 2026-06-05 | 2026-06-08 | Status |
|------|-----------|-----------|--------|
...
| INFO-18 (PyJWT CVE-2026-48526 algorithm confusion) | — | New | Not exploitable |
| INFO-19 (aiohttp CVE-2026-47265 cookie leak) | — | New | Not exploitable |
...
- 2 new INFO findings added after fresh CVE database check:
  - **INFO-18:** CVE-2026-48526 (PyJWT algorithm confusion, fixed in 2.13.0) — not exploitable in WineBox (single HS256 algorithm, no JWK keys).
  - **INFO-19:** CVE-2026-47265 (aiohttp cross-origin redirect cookie leak, fixed in 3.14.0) — not exploitable in WineBox (aiohttp is transitive only, never used directly).
