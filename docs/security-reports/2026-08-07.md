...
- One infrastructure commit since last review: `60acc58` adds `invoke prod-ssl` task for apex cert renewal and removes the dead `auto-merge-security-clean.yml` GitHub Actions workflow. No application code changes. No security concerns.
...
| Item | 2026-08-06 | 2026-08-07 | Status |
|------|-----------|-----------|--------|
...
- One infrastructure commit: `60acc58` — adds `invoke prod-ssl` task for apex cert renewal (winebox.app + www.winebox.app) with certbot renewal hooks, and removes the dead `auto-merge-security-clean.yml` GitHub Actions workflow. No application code changes. No security concerns — the prod-ssl task follows established patterns in the codebase.
