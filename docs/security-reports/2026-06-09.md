...
**Notable context:** No application code changes since the last review (2026-06-08). HEAD is at commit `80a17d2` (the 2026-06-08 security review merge). Dependency versions unchanged. Two new CVEs discovered for transitive dependencies: urllib3 CVE-2026-44431 (header disclosure via ProxyManager) and aiohttp CVE-2026-34993 (CookieJar deserialization); neither is exploitable in WineBox's configuration. All 19 INFO-level findings carried forward; 2 new INFO findings added (INFO-20, INFO-21). INFO-16 updated with two additional `to_list(length=None)` locations.
...
- **Status:** Updated from 2026-05-31 review (2 additional locations found in `cellar_inventory.py` and `cellar_debit.py`).
...
- **Status:** New finding in 2026-06-09 review.
...
- Only commits since last review: `80a17d2` (merge of 2026-06-08 security review — documentation only).
...
**Codebase version:** 0.7.85 (commit 80a17d2)

### Comparison with Previous Review (2026-06-08)

| Item | 2026-06-08 | 2026-06-09 | Status |
|------|-----------|-----------|--------|
...
| INFO-16 (unbounded to_list() calls) | 2 locations | 4 locations | Updated |
...
| INFO-20 (urllib3 CVE-2026-44431 header disclosure) | — | New | Not exploitable |
| INFO-21 (aiohttp CVE-2026-34993 CookieJar deser.) | — | New | Not exploitable |

### Changes Since Last Review

- No code changes since last review. All dependency versions unchanged.
- All 19 INFO-level findings carried forward.
- INFO-16 updated with 2 additional `to_list(length=None)` locations (`cellar_inventory.py:88`, `cellar_debit.py:142`).
- 2 new INFO findings added after fresh CVE database check:
  - **INFO-20:** CVE-2026-44431 (urllib3 header disclosure via ProxyManager, fixed in 2.7.0) — not exploitable in WineBox (ProxyManager not used anywhere).
  - **INFO-21:** CVE-2026-34993 (aiohttp CookieJar deserialization, fixed in 3.14.0) — not exploitable in WineBox (aiohttp is transitive only, CookieJar.load() not used).
